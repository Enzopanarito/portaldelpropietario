(function () {
  ...
  function render(data) {
    ...
    document.getElementById('plant-module-body').innerHTML =
      ...
      '<div id="plant-participation" class="plant-admin-panel"><div class="plant-panel-title"><div><h3>Participación por casa</h3><p>“Ver como propietario” abre la misma respuesta canónica del portal. “Control manual” viene precargado y solo requiere su confirmación.</p></div></div><div class="plant-table-wrap"><table><thead><tr><th>Casa</th><th>Estado</th><th>Reglas</th><th>Reincorporación</th><th>Control</th></tr></thead><tbody>' + houseRows(data.houses || []) + '</tbody></table></div></div>' +
