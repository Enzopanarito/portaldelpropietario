...
assert(edge.includes("owner-mobile-fluid-v2-payment-report-tracking-v16-2026-08-30-plant-visible-status-v1"),'El release móvil debe romper caché sin perder la política estricta de moneda ni el estado visible de planta.');
