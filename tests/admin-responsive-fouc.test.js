...
assert(edge.includes('const loader=`<div id="vla-admin-loader"'),'Falta el elemento HTML de la pantalla de carga premium.');
assert(edge.includes("!html.includes('<div id=\"vla-admin-loader\"')"),'La detección del loader debe buscar el elemento HTML exacto y no coincidir con su CSS.');
