...
function payload(){return{propietarios:Array.from({length:15},(_,index)=>({Casa:index+1,saldoUsd:index===7?70:0,saldoBsRef:index===7?-.03:0,totalPagadero:index===7?70:0,saldoNetoReferencial:index===7?69.97:0,balanceEngineVersion:OWNER_BALANCE_CONTRACT}))}}
