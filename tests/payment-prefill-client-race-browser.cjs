...
async function fixturePage(browser,{compressLegacyWatchdog=false,loadIntelligence=true}={}){
 ...
 if(loadIntelligence)await page.addScriptTag({path:path.resolve('payment-report-intelligence.js')});
