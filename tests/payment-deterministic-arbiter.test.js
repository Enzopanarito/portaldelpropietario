...
(()=>{
 ...
 const exactPhoneAcrossVesMethods=arbiter.evaluatePaymentReport(base({
  ...
  authorizedAccounts:[account({Método:'Pago móvil Venezuela',Moneda:'VES','Banco o Plataforma':'BANESCO','Titular Autorizado':'','Correo Normalizado':'','Teléfono Normalizado':'04140554700'})],
