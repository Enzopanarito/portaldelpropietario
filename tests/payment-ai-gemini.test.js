...
(async()=>{
 ...
 assert.deepStrictEqual(body.generationConfig.thinkingConfig,{thinkingBudget:0},'Gemini 2.5 debe omitir razonamiento para extracción rápida.');
 assert(!Object.prototype.hasOwnProperty.call(body.generationConfig,'temperature'),'No usar sampling obsoleto en Gemini 3.6+.');
 assert.deepStrictEqual(gemini.thinkingConfigFor('gemini-3.5-flash'),{thinkingLevel:'minimal'});
