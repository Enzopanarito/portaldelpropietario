...
(()=>{
 ...
 const realBcv=decision.effectivePayment(green({'Forma de Pago Reportada':'Bs BCV','Equivalente USD Reportado':145.83,'Monto Reportado Bs':113370.59,'Tasa BCV Reporte':777.4161,'Moneda Ingresada':'VES','Monto Ingresado':113370.59}),{});assert.strictEqual(realBcv.ok,true);assert.strictEqual(realBcv.rate,777.4161);assert.strictEqual(realBcv.amountUsd,145.83);
 const roundedUsd=decision.effectivePayment(green({'Forma de Pago Reportada':'Bs BCV','Equivalente USD Reportado':145.83,'Monto Reportado Bs':113369.40,'Tasa BCV Reporte':777.4161,'Moneda Ingresada':'VES','Monto Ingresado':113369.40}),{});assert.strictEqual(roundedUsd.ok,true,'Una diferencia legítima por redondeo a centavos USD debe ser coherente.');
 ...
 const badBs=decision.effectivePayment(green({'Forma de Pago Reportada':'Bs BCV','Equivalente USD Reportado':50,'Monto Reportado Bs':9900,'Tasa BCV Reporte':200,'Moneda Ingresada':'VES','Monto Ingresado':9900}),{});assert.strictEqual(badBs.ok,false);
