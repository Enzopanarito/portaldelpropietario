...
(()=>{
 ...
 assert.strictEqual(snapshot.validateSnapshotStillCurrent(withExpense,{owner:expenseOwner,expenses:[expense],payments:[],officialRecords:[expenseOfficial],bcvRate:50,now}).reason,'SNAPSHOT_NOT_AUTOMATICALLY_ELIGIBLE');
