...
assert(store.includes('getAtomicStore(STORE_NAME)'),'La fotografía pública debe usar el almacén atómico de Netlify.');
assert(!store.includes("consistency:'strong'"),'Este runtime no expone uncachedEdgeURL; la consistencia fuerte dejaría el almacén indisponible.');
