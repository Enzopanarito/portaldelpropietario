...
const MOBILE_RELEASE='owner-mobile-fluid-v2-payment-report-tracking-v16-2026-08-30-plant-visible-status-v1';
...
export default async (request,context)=>{
  ...
  if(!html.includes('id="vla-owner-mobile-v2"')){
    ...
    if(!html.includes('id="vla-owner-plant-v1-css"'))extras+=`<meta name="vla-owner-plant" content="service-status-v2"><link id="vla-owner-plant-v1-css" rel="stylesheet" href="${PLANT_STYLE_HREF}">`;
  ...
  headers.set('x-vla-owner-plant','service-status-v2');
