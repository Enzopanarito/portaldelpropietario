...
const MOBILE_RELEASE='owner-mobile-fluid-v2-payment-smart-v6-submit-r1-2026-08-03';
...
export default async (request,context)=>{
  ...
  headers.set('x-vla-owner-release',MOBILE_RELEASE);
  headers.set('x-vla-owner-payment-report','smart-v6');
