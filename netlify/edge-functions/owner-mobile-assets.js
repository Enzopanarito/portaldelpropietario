...
const MOBILE_RELEASE='owner-mobile-fluid-v2-payment-validation-v10-2026-08-12';
...
const PAYMENT_VALIDATION_HREF=`/owner-payment-validation-v10.js?v=${MOBILE_RELEASE}`;
...
export default async (request,context)=>{
  ...
  if(!html.includes('id="vla-owner-mobile-v2"')){
    ...
    if(!html.includes('id="vla-owner-payment-validation-v10"'))extras+=`<meta name="vla-payment-validation" content="v10"><script id="vla-owner-payment-validation-v10" defer src="${PAYMENT_VALIDATION_HREF}"></script>`;
  ...
  headers.set('x-vla-owner-payment-report','progressive-v8');
  headers.set('x-vla-payment-validation','v10');
