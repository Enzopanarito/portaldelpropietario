...
const MOBILE_RELEASE='owner-mobile-fluid-v2-payment-progressive-v6-2026-08-08';
...
export default async (request,context)=>{
  ...
  headers.set('x-vla-owner-payment-report','progressive-v6');
