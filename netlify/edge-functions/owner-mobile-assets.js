...
const MOBILE_RELEASE='owner-mobile-fluid-v2-payment-report-final-v10-2026-08-14';
...
export default async (request,context)=>{
  ...
  headers.set('x-vla-owner-payment-report','progressive-v10');
