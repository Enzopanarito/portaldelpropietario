...
const MOBILE_RELEASE='owner-mobile-fluid-v2-payment-report-tracking-v13-2026-08-15-cross-device-v1-plant-v1-2026-08-21-prefill-runtime-v1-2026-08-24';
...
const PAYMENT_PREFILL_RUNTIME_HREF=`/owner-payment-prefill-runtime-v1.js?v=${MOBILE_RELEASE}`;
...
const PLANT_STYLE_HREF=`/owner-plant-v1.css?v=${MOBILE_RELEASE}`;
const PLANT_UI_HREF=`/owner-plant-v1.js?v=${MOBILE_RELEASE}`;
...
export default async (request,context)=>{
  ...
  if(!html.includes('id="vla-owner-mobile-v2"')){
    ...
    if(!html.includes('id="vla-payment-prefill-runtime-v1"'))extras+=`<script id="vla-payment-prefill-runtime-v1" defer src="${PAYMENT_PREFILL_RUNTIME_HREF}"></script>`;
    ...
    if(!html.includes('id="vla-owner-plant-v1-css"'))extras+=`<meta name="vla-owner-plant" content="intelligent-v1"><link id="vla-owner-plant-v1-css" rel="stylesheet" href="${PLANT_STYLE_HREF}">`;
    if(!html.includes('id="vla-owner-plant-v1"'))extras+=`<script id="vla-owner-plant-v1" defer src="${PLANT_UI_HREF}"></script>`;
  ...
  headers.set('x-vla-owner-plant','intelligent-v1');
  headers.set('x-vla-payment-prefill-runtime','v1');
