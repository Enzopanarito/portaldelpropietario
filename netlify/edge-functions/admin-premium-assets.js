...
const ADMIN_PLANT_RELEASE='admin-plant-v3-2026-08-30-service-suspension-v1';
...
export default async (request,context)=>{
  ...
  if(html.includes('vla-admin-plant-v1'))headers.set('x-vla-admin-plant','service-status-v2');
