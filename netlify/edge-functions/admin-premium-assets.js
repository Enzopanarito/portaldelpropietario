...
const ADMIN_PLANT_RELEASE='admin-plant-v2-2026-08-29-participation-plans-v1';
...
export default async (request,context)=>{
  ...
  if(html.includes('vla-admin-plant-v1'))headers.set('x-vla-admin-plant','intelligent-v1');
