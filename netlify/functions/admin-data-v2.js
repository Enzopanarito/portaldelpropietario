...
const FIELD_SETS = {
  ...
  gastos: ['Concepto','Monto','Tipo de Gasto','Frecuencia','Propietarios','Forma de Pago','Mes de Aplicación','Estado del Gasto','Origen del Gasto','Clave de Plantilla','Clave Recurrente','Repetición Activa'],
  ...
  reportes: ['Reporte','Propietario que Reporta','Monto Reportado','Referencia','Fecha del Reporte','Estado','Forma de Pago Reportada','Monto Reportado Bs','Tasa BCV Reporte','Equivalente USD Reportado','Moneda Ingresada','Monto Ingresado','Banco Reportado','Observaciones Reportadas','Fuente Tasa BCV Reporte','Archivo Obligatorio','Comprobante Blob Key','Comprobante Nombre Original','Comprobante MIME','Comprobante Bytes','Complemento Blob Key','Complemento SHA-256','Complemento Nombre Original','Complemento MIME','Complemento Bytes','Estado de Procesamiento','Resultado Validación','AI Confidence','AI Provider Principal','AI Model Principal','AI Model Secundario','AI Fallback Used','AI Segunda Lectura Fecha','AI Failure Reason','AI Analysis Started At','AI Analysis Completed At','Prompt Version','Parser Version','Normalized Analysis JSON','Método Detectado','Banco o Plataforma Detectada','Moneda Detectada','Monto Detectado','Fecha Operación Detectada','Fuente Fecha Operación','Confianza Fecha Operación','Fecha Requiere Revisión','Evidencia Fecha Operación','Hora Detectada','Estado Transacción Detectado','Receptor Detectado','Teléfono Receptor Detectado','Correo Receptor Detectado','Cuenta Receptora Visible','Últimos 4 Receptor Detectados','Documento Receptor Detectado','Binance ID Receptor Detectado','Emisor Detectado','Cuenta Emisora Visible','Clasificación Receptor','Coincidencia Receptor','Evidencia Receptor','Cuenta Autorizada Coincidente','Receptor Esperado','Referencia Detectada','Posible Duplicado','Nivel de Duplicado','Puntaje de Duplicado','Tipo de Coincidencia','Evidencia de Duplicado','Detalle de Coincidencia','Detalle de Inconsistencias','Solicitud de Información','Fecha Solicitud Información','Respuesta del Propietario','Fecha Respuesta Propietario','Alerta Aceptada por Propietario','Alertas Presentadas','Decisión Administrativa','Correcciones Administrativas JSON','Validación Realizada Por'],
