...
function extractionPrompt({promptVersion='',report={}}={}){
 ...
 return[
  ...
  'Devuelve siempre estas propiedades exactas; usa null cuando un dato no sea visible:',
  '{"method":"TRANSFER_VE|MOBILE_PAYMENT_VE|ZELLE|TRANSFER_US|BINANCE_PAY|CRYPTO_TRANSFER|OTHER|UNKNOWN","bank_or_platform":string|null,"amount":number|null,"currency":"VES|USD|UNKNOWN","transaction_date":"YYYY-MM-DD"|null,"transaction_time":"HH:mm:ss"|null,"reference":string|null,"transaction_status":"COMPLETED|SENT|PROCESSED|PENDING|SCHEDULED|FAILED|CANCELLED|REJECTED|UNKNOWN","recipient_name":string|null,"recipient_phone":string|null,"recipient_email":string|null,"recipient_account_visible":string|null,"recipient_document":string|null,"recipient_binance_id":string|null,"memo":string|null,"confidence":number,"critical_fields_visible":boolean,"warnings":string[],"possible_visual_modification":boolean}',
  'Reconoce comprobantes de bancos venezolanos, pago móvil, Zelle, transferencias de Estados Unidos y Binance.',
  'recipient_* siempre describe al DESTINATARIO o BENEFICIARIO que recibió el dinero, nunca al ordenante/remitente. Si no puedes distinguirlos con certeza usa null y explica la ambigüedad en warnings.',
  'En Pago Móvil busca específicamente teléfono receptor y cédula/RIF del receptor. Conserva el formato visible; no inventes dígitos.',
  'En transferencias bancarias busca específicamente número de cuenta beneficiaria y cédula/RIF del beneficiario. No confundas la cuenta origen con la cuenta receptora.',
  'En Zelle busca el correo del destinatario. El nombre por sí solo no identifica al receptor autorizado.',
  'En Binance busca el correo del destinatario y, cuando aparezca, Binance Pay ID/UID/ID del destinatario en recipient_binance_id. No inventes un ID si no está visible.',
  ...
  'critical_fields_visible solo puede ser true cuando se ven monto, moneda o activo, fecha, referencia, estado y algún dato fuerte del receptor. El nombre del receptor por sí solo no cuenta como identificador fuerte.',
