...
const AUDIENCE = 'vla-backup-production-readonly';
...
async function fetchJson(url, fetchImpl) {
  const response = await fetchImpl(url, { headers: { Accept: 'application/json', 'User-Agent': 'VLA-Backup-CI' } });
...
async function verifyBackupOidcToken(token, options = {}) {
