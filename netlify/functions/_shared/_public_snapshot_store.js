...
function validOwner(owner){
 ...
 if(!(Number.isInteger(house)&&house>=1&&house<=EXPECTED_HOUSES&&[usd,bs,total].every(Number.isFinite)&&Math.abs((usd+bs)-total)<=0.011&&owner?.balanceEngineVersion==='vla-balance-contract-v7'))return false;
