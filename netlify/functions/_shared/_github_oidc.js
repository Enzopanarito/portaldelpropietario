...
const AUDIENCE = 'vla-admin-production-readonly';
const REPOSITORY = 'Enzopanarito/portaldelpropietario';
const REPOSITORY_OWNER = 'Enzopanarito';
const WORKFLOW = 'Verify Admin Production';
const WORKFLOW_REF = 'Enzopanarito/portaldelpropietario/.github/workflows/verify-admin-production.yml@refs/heads/main';
...
async function fetchJson(url, fetchImpl) {
  const response = await fetchImpl(url, { headers: { Accept: 'application/json', 'User-Agent': 'VLA-Admin-CI' } });
